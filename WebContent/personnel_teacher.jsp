    ...
    <div class="content">
        ...
        <table id="tb" class="table">
            ...
            <tr>
            	...
            	<tr class="t_t">
                	<td style="background-color:pink;">${i.teacherName }</td>
	                <td style="background-color:pink;">${i.teacherNumber }</td>
	                <td style="background-color:pink;">${i.phone }</td>
	                <td style="background-color:pink;">${i.teacherSex }</td>
	                <td style="background-color:pink;">老师</td>
...
$(function () {
	...
	if(list==null){
		window.location.href="admin_getAllTeacher";
	}
