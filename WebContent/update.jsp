	...
	<body onload="setup();preselect('省份');promptinfo();">
		...
		<div class="form">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				学 &nbsp;&nbsp;号：<input type="text" name="id" id="id" placeholder="student number" /><br/>
				班 &nbsp;&nbsp;级：<input type="text" name="squad" id="squad"
				placeholder="In the class" />
				<br/>
				  
				姓 &nbsp;&nbsp;名：<input type="text" name="studentName" id="name" placeholder="name*" /><br/>
