    ...
    <div class="content">
        ...
        <table id="tb" class="table">
            ...
            <c:forEach var="i" items="${requestScope.list}" varStatus="st">
            	<tr class="t_t">
                	<td style="background-color:pink;">${i.studentName }</td>
	                <td style="background-color:pink;">${i.studentNumber }</td>
	                <td style="background-color:pink;">${i.phone }</td>
	                <td style="background-color:pink;">${i.danceclass_id }</td>
	                <td style="background-color:pink;">${i.studentSex }</td>
...
$(function () {
	...
	if(list==null){
		window.location.href="admin_findAllStudent";
	}
